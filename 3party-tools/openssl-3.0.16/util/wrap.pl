...
BEGIN {
    ...
    require '/home/tony/Pratice/Python/Pytorch/MNIST/openssl-3.0.16/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/tony/Pratice/Python/Pytorch/MNIST/openssl-3.0.16/test/fips-and-base.cnf';
    shift;
